...
public class MilkBucket extends BucketItem {

	public Fluid fluid;

	public MilkBucket(Identifier id, Item.Settings settings) {
		
		super(Mod1Fluids.MILK, settings);
		this.fluid = Mod1Fluids.MILK;
